...
are sufficiently weakly coupled exterior to the apparent horizon
...
(as the speed of propagation of the scalar
field $\phi$ may be less or greater than the local speed of light,
by ``apparent horizon'' we mean the outermose trapped region for all
of the characteristic speeds; for more discussion see for example
\refcite{Benkel:2018qmh}).
