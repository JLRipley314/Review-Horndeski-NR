...
for more discussion see Ref.~\refcite{Kobayashi:2019hrl}.
%===========================================================================
...
posits that naked singularities do not form from generic initial
data in GR coupled to ``standard'' matter fields (for example 
minimally coupled scalar field matter).
...
\begin{enumerate}
   ...
   \item Infinitely steep gradients can form in the solution--that is
      \emph{shocks} or 
...
This remains a relatively unexplored topic.
...
\section*{Acknowledgments}
 ...
 Harvey Reall, Leo Stein, Maxence Corman, and William East
 for helpful discussions,
 and thank Abhishek Hegde, Aron Kovacs, 
 Tomas Galvez-Ghersi, Maxence Corman, and
 Tiago Fran\c{c}a for helpful comments on an earlier
